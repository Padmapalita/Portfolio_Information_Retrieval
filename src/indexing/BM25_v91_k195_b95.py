...
def create_BM25_in_one(include_description=False):
  ...
  #print(bm25_df[:5])
  bm25_df.to_pickle("../../Files/Local_pickles/BM25_v901_k195_b95.pkl")  
  
  print('bm25_df.to_pickle("../../Files/Local_pickles/BM25_v901_k195_b95.pkl") ')
  print("index has been created and pickled in ../../Files/Local_pickles/BM25_v901_k195_b95.pkl")
  return True
